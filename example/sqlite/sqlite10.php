...
<head>
	...
	<link rel="shortcut icon" href="../../img/glider.ico">
 	<title>Exempel PHP PDO och SQLite. Gör sökfunktion via _GET</title>
</head>
...
if(isset($_GET['search']) && !empty($_GET['search'])) {
	$stmt = $db->prepare('
		SELECT * FROM Jetty WHERE boatType LIKE ? OR boatEngine = ? OR ownerName = ?;
	');
	...
	*/
	...
	echo "<p>Enter string to search, use % as wildcard. Try for example to search for %uster%.";
}
