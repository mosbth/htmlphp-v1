...
<article>
	...
	<aside class="right">
		...
		<aside class="box">
			...
			<p>
				Liknande undersökningar är bra eftersom det ger oss möjlighet att studera hur gemene man
				skriver webbsidor i allmänhet.
			</p>
			<p>
	...
	<section class="content">
		...
		<section id="part-I">
			...
			<section id="doctype"> <!-- - - - - - - - - - - - - Sub section - - - - - - - - - - - -  -->
				<h3>&lt;!DOCTYPE&gt;</h3>
				<p>
...
&lt;/script&gt; 
		...
		<section id="part-II">
			...
			<section id="div_id_top"> <!-- - - - - - - - - - - - - Sub section - - - - - - - - - - - -  -->
...
&lt;/body&gt; 
			...
			<section id="div_id_footer"> <!-- - - - - - - - - - - - - Sub section - - - - - - - - - - - -  -->
...
&lt;/body&gt; 
			...
			<section id="div_id_content"> <!-- - - - - - - - - - - - - Sub section - - - - - - - - - - - -  -->
				...
				<p>
					...
					#main eller liknande. Ofta har detta strukturell påverkan och underlättar hantering i 
				...
				<p>
					Sidornas layout kan skilja mellan varandra beroende på vilken typ av information 
					som presenteras. 
				</p>
				<p>
...
&lt;/ul&gt;
			...
			<section id="blockquote"> <!-- - - - - - - - - - - - - Sub section - - - - - - - - - - - -  -->
				<h3>&lt;blockquote&gt;</h3>
				<p>
