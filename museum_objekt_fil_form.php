...
<!-- - - - - - - - - - - - - - - - - - aside        - - - - - - - - - - - - - - - - - -->
	<aside class="right">
		...
		<aside class="box">
			...
			<p>Alla bilder skalas om till gemensamma standardskalor. <a href="museum/img/resize_images.php">Dubbelkolla att det är
			gjort för alla bilder</a>.</p>
		...
		<form class="standard" action="?id=<?php echo $id; ?>" method=post>
		 <fieldset>
			...
			<figure class="standard strict inline w550">
				<a href="<?php echo $obj['image']; ?>"><img src="<?php echo modifyImgUrl($obj['image'],550); ?>" alt="[Bild saknas]"></a>
			</figure>
