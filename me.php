...
<div class="wrap">
	...
	<section class="content">
		<section class="columns2">
			...
			<p>
			Mitt namn är Mikael Roos och jag är ansvarig för denna kursen och kursklustret som jag valt att
			kalla för db-o-webb.
			</p>
			
			<p>
			Jag jobbar sedan 2006 på Blekinge Tekniska Högskola. Jag jobbade även här ett par år i mitten av 90-talet (92-95).
			...
			<p>
			2005 bestämde jag mig för att avsluta min management-inriktade karriär och återgå till tekniken. 
			På något sätt hamnade jag då vid BTH och där sitter vi nu. 
			</p>
			<p>
			Jag jobbar numer full tid som lärare
